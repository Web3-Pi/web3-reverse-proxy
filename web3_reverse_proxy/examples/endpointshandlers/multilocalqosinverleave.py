...
class MultiEndpointLocalInterleaveQoSHandler(EndpointsHandler):
    ...
    def __init__(self, name: str, conn_descr: EndpointConnectionDescriptor, state_updater: StateUpdater) -> None:
        ...
        self.tg.add_processing_thread(self.request_consumer, Queues.IN_0, Queues.OUT_0, self.endpoint_0)
        self.tg.add_processing_thread(self.request_consumer, Queues.IN_1, Queues.OUT_0, self.endpoint_1)
