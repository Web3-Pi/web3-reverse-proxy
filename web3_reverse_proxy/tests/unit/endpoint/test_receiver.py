...
class ResponseReceiverGethTests(TestCase):
    ...
    def test_receive_compressed_response(self):
        ...
        callback.assert_has_calls([
            call(b'HTTP/1.1 200 OK\r\nContent-Encoding: gzip\r\nContent-Type: application/json\r\nDate: Wed, 03 Apr 2024 22:45:33 GMT\r\nContent-Length: 62\r\n\r\n\x1f\x8b\x08\x00'),
            call(b'\x00\x00\x00\x00\x00\xff\xaaV\xca*\xce\xcf+*HV\xb2R2\xd23P\xd2Q\xcaLQ\xb22\xd0Q*J-.\xcd)Q\xb2R2T\xaa\xe5\x02\x04\x00\x00\xff\xff\xbaeLj&\x00\x00\x00'),
        ])
...
class ResponseReceiverSSLTests(TestCase):
    ...
    def test_receive_chunked_response(self):
        self.rfile_mock.recv.side_effect = [
            b'HTTP/1.1 200 OK\r\n',
        ...
        expected_callback_calls = [
            call(b'HTTP/1.1 200 OK\r\n'),
            call(b'Transfer-Encoding: chunked\r\n'),
            call(b'Content-Type: application/json\r\n'),
            call(b'Date: Wed, 03 Apr 2024 22:45:33 GMT\r\n'),
            call(b'\r\n'),
            call(b'5\r\n'),
            call(b'{"Hel\r\n'),
            call(b'A\r\n'),
    ...
    def test_receive_regular_response(self):
        ...
        callback_mock.assert_has_calls([
            call(b'HTTP/1.1 200 OK\r\n'),
            call(b'Content-Type: application/json\r\n'),
            call(b'Date: Wed, 03 Apr 2024 22:41:40 GMT\r\n'),
            call(b'Content-Length: 38\r\n'),
            call(b'\r\n'),
            call(b'{"jsonrpc":"2.0","id":0,"result":"1"}\n'),
        ])
    ...
    def test_receive_compressed_response(self):
        self.rfile_mock.recv.side_effect = [
            ...
            b'Content-Length: 62\r\n',
            b'\r\n',
            b'\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\xaaV\xca*\xce\xcf+*HV\xb2R2\xd23P\xd2Q\xcaLQ\xb22\xd0Q*J-.\xcd)Q\xb2R2T\xaa\xe5\x02\x04\x00\x00\xff\xff\xbaeLj&\x00\x00\x00',
        ]
        receiver = ResponseReceiverSSL(self.get_socket())
        callback_mock = Mock()
        ...
        callback_mock.assert_has_calls([
            call(b'HTTP/1.1 200 OK\r\n'),
            call(b'Content-Encoding: gzip\r\n'),
            call(b'Content-Type: application/json\r\n'),
            call(b'Date: Wed, 03 Apr 2024 22:45:33 GMT\r\n'),
            call(b'Content-Length: 62\r\n'),
            call(b'\r\n'),
            call(b'\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\xaaV\xca*\xce\xcf+*HV\xb2R2\xd23P\xd2Q\xcaLQ\xb22\xd0Q*J-.\xcd)Q\xb2R2T\xaa\xe5\x02\x04\x00\x00\xff\xff\xbaeLj&\x00\x00\x00'),
        ])
    ...
    def test_receive_rpc_error_response(self):
        self.rfile_mock.recv.side_effect = [
            ...
            b'Content-Length: 77\r\n',
            b'\r\n',
            b'{"jsonrpc":"2.0","id":0,"error":{"code":35000,"message":"An error occurred"}}',
        ]
        receiver = ResponseReceiverSSL(self.get_socket())
        callback_mock = Mock()
        ...
        callback_mock.assert_has_calls([
            ...
            call(b'Content-Type: application/json\r\n'),
            call(b'Date: Wed, 03 Apr 2024 22:41:40 GMT\r\n'),
            call(b'Content-Length: 77\r\n'),
            call(b'\r\n'),
            call(b'{"jsonrpc":"2.0","id":0,"error":{"code":35000,"message":"An error occurred"}}'),
        ])
