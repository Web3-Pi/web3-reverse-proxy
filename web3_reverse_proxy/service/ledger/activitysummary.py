...
class UserActivitySummary:
    ...
    def update(self, method: str, req_bytes: int, resp_bytes: int, num_calls: int) -> None:
        # with self.__lock:
...
class ServiceActivitySummary:
    ...
    def get_user_activity_summary(self, user_api_key: str) -> Optional[UserActivitySummary]:
        res = None
        # with self.__lock:
        if user_api_key in self.users_summaries:
