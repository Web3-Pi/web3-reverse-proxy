...
class EndpointConnectionPoolTests(TestCase):
    ...
    @patch(
        "web3_reverse_proxy.core.rpc.node.endpoint_pool.endpoint_connection_pool.EndpointConnectionHandler"
    )
    ...
    @patch(
        "web3_reverse_proxy.core.rpc.node.endpoint_pool.endpoint_connection_pool.EndpointConnection"
    )
    @patch(
        "web3_reverse_proxy.core.rpc.node.endpoint_pool.endpoint_connection_pool.EndpointConnectionHandler"
    )
